...
if(isset($_POST['save_civil_service'])){
    ...
    foreach ($updateCivilServiceDetails as $service) {
        $userID = $_SESSION['id'];
        $career = $service['up_career'];
        $rating = $service['up_rating'];
        $examination = $service['up_examination'];
        $place = $service['up_place'];
        $number = $service['up_number'];
        $validity = $service['up_validity'];       
        ...
        $stmt_executeUpdateCivilService = $stmt_executeUpdateCivilService->execute();
