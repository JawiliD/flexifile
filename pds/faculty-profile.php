            ...
            <div class="container text-start">
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <div class="input-group input-group-sm mb-3">
                            <p>House/Block/Lot No. <?php echo $rowpersonal['residential_house_no'];  ?></p> 
                        </div>
                        <div class="input-group input-group-sm mb-3">
                            <p>Street: <?php echo $rowpersonal['residential_street'];  ?></p> 
                        </div>
                        <div class="input-group input-group-sm mb-3">
                            <p>Subdivision/Village: <?php echo $rowpersonal['residential_subdivision'];  ?></p> 
                        </div>
                        <div class="input-group input-group-sm mb-3">
                            <p>Barangay: <?php echo $rowpersonal['residential_barangay'];  ?></p> 
                        </div>
                        <div class="input-group input-group-sm mb-3">
                            <p>City/Municipality: <?php echo $rowpersonal['residential_municipality'];  ?></p> 
                        </div>
                        <div class="input-group input-group-sm mb-3">
                            <p>Province: <?php echo $rowpersonal['residential_province'];  ?></p> 
                        </div>
                        <div class="input-group input-group-sm mb-3">
                        ...
                        <div class="input-group input-group-sm mb-3">
                            <p>House/Block/Lot No. <?php echo $rowpersonal['permanent_house_no'];  ?></p> 
                        </div>
                        <div class="input-group input-group-sm mb-3">
                            <p>Street: <?php echo $rowpersonal['permanent_street'];  ?></p> 
                        </div>
                        <div class="input-group input-group-sm mb-3">
                            <p>Subdivision/Village: <?php echo $rowpersonal['permanent_subdivision'];  ?></p> 
                        </div>
                        <div class="input-group input-group-sm mb-3">
                            <p>Barangay: <?php echo $rowpersonal['permanent_barangay'];  ?></p> 
                        </div>
                        <div class="input-group input-group-sm mb-3">
                            <p>City/Municipality: <?php echo $rowpersonal['permanent_municipality'];  ?></p> 
                        </div>
                        <div class="input-group input-group-sm mb-3">
                            <p>Province: <?php echo $rowpersonal['permanent_province'];  ?></p> 
                        </div>
                        <div class="input-group input-group-sm mb-3">
                            <p>Zipcode: <?php echo $rowpersonal['permanent_province'];  ?></p>
                        </div>
                    </div>
